...
export default function Sidebar() {
  ...
  return (
    <div className="w-fit min-h-screen bg-gray-800 p-2 fixed left-0">
      <div className="flex group">
        ...
        <div className="fixed align-middle rounded-md ml-[3rem] mt-1 hidden group-hover:block bg-gray-800">
          <p className="p-3">Clear Screen</p>
        </div>
      </div>
      <div className="flex group">
