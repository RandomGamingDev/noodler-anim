    ...
    <div className="w-full h-[20%] bg-gray-800 z-[-1] border border-gray-700">
      <div className="flex border border-gray-700">
        ...
        <div className="flex pl-3">
          <p>Frame</p>
          <DraggableInput value={frame} onChange={(e) => setFrame(Number(e.currentTarget.value))}></DraggableInput>
          <p>FPS</p>
          <DraggableInput value={fps} onChange={(e) => setFps(Number(e.currentTarget.value))}></DraggableInput>
        </div>
      </div>
